import { HttpJsonBody } from "../../types/http/body";
 ...
 */
export declare function httpPost({ url, headers, params, body }: Omit<PartialBy<HttpMethodParams, "headers" | "params">, "body"> & {
    body: HttpJsonBody;
}): Promise<any>;
